...
public class BookDatabaseHelper {
  ...
  public void openDatabase() {
    if ((db == null || !db.isOpen()) && (new File(Utils.getDatabasePath(mContext, Language.THAI))).exists()) {
      db = SQLiteDatabase.openDatabase(Utils.getDatabasePath(mContext, Language.THAI), null, 0);
    }
  }
  ...
  static Map<String,Map<String,Map<String,ArrayList<Integer>>>> thaiMSBookItems = null;
  ...
  public static Map<String,Map<String,Map<String,ArrayList<Integer>>>> getThaiMSBookItems(Context context) {
    if (thaiMSBookItems != null) {
      return thaiMSBookItems;
    }
    thaiMSBookItems = getBookItems(context, "book_item_thaims.json");
    return thaiMSBookItems;
  }
  ...
  public static Map<String, Object> getConvertItemMap(Context context,
